  ...
  const body = JSON.stringify({
    ...
    services: [
      ...
      },
      {
        ...
        status: "degraded",
        load: randInt(91, 4),
        ping: `${randInt(120, 20)}ms`,
      },
      {
        name: "ML Engine",
        status: "online",
        load: randInt(77, 8),
        ping: `${randInt(22, 6)}ms`,
      },
      {
        name: "Cache Layer",
        status: "online",
    ...
    tasks: [
      ...
      {
        id: 4,
        name: "Neural Net Training",
        progress: randInt(63, 4),
        status: "running",
        priority: "high",
      },
      {
    ...
    alerts: [
      {
        type: "warn",
        msg: `Memory usage at ${Math.round((ramUsed / ramTotal) * 100)}% — consider clearing cache`,
        time: "2m ago",
      },
      {
        type: "info",
        msg: "Scheduled maintenance window in 4 hours",
        time: "15m ago",
      },
      {
        type: "success",
        msg: "Backup completed successfully (14.2 GB)",
        time: "1h ago",
      },
    ],
  });
